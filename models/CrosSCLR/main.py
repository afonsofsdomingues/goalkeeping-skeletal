...
if __name__ == '__main__':
    ...
    # added command alias for finetuning
    processors['finetune_crossclr_3views'] = import_class('processor.pretrain_crossclr_3views.CrosSCLR_3views_Processor')
    # added command alias for full training (native)
    processors['fulltrain_crossclr_3views'] = import_class('processor.pretrain_crossclr_3views.CrosSCLR_3views_Processor')
